...
Be concise, friendly, and use markdown formatting. Keep answers under 200 words unless the user asks for detail. Use bullet points and bold text for readability.`,
          },
          ...messages,
        ],
        stream: true,
